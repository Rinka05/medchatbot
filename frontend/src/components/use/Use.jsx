    ...
    <section id="uses">
      ...
      <div className="useBars">
        ...
        <div className="useBar">
          ...
          <div className="useBarText">
            <h2>Step 3</h2>
            <p>care will analyze your input and provide relevant medical information and recommendations.</p>
          </div>
        </div>
        <div className="useBar">
          {/* <img src={img3} className="useBarImg"/> */}
        ...
        <div className="useBar">
          ...
          <div className="useBarText">
            <h2>Step 5</h2>
            <p>care is available 24/7, so you can chat anytime you require medical assistance.</p>
          </div>
        </div>
      </div>
    </section>
